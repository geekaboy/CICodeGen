...
(function ($) {
    ...
    $.extend($.fn.bootstrapTable.defaults, {
        ...
        filterTemplate: {
            ...
            select: function (that, field, isVisible) {
                return sprintf('<select class="form-control form-control-sm bootstrap-table-filter-control-%s" style="width: 100%; visibility: %s" dir="%s"></select>',
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.filterControl && this.options.filterShowClear) {
            ...
            if (!$btnClear.length) {
                $btnClear = $([
                    '<button class="btn btn-outline-secondary filter-show-clear" ',
